    ...
    <div class="hello">
        <Card class="record" shadow v-if="cut">
            ...
            <Form :model="formlogin" :label-width="68">
                ...
                <FormItem label="密码">
                    <Input type="password" placeholder="请输入 6~20 位的密码" v-model="formlogin.password" />
                </FormItem>
            </Form>
        ...
        <Card class="record" shadow v-else>
            ...
            <Form :model="formRegister" :label-width="68">
                ...
                <FormItem label="密码">
                    <Input placeholder="请输入 6~20 位的密码" v-model="formRegister.password" type="password" />
                </FormItem>
                <FormItem label="确认密码">
                    <Input placeholder="请再输入一次密码" v-model="formRegister.confirmPassword" type="password" />
                </FormItem>
            </Form>
