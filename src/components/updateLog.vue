<template>
  ...
  <div>
    ...
    <p style="font-size: 30px; color: red">
      ...
      <br />
      开服福利CDK：20102300008FGTP8C65P 10级礼包CDK:201111000076ZS79XZ54
      <br />
      10级限量礼包CDK：2012110000DDM28FGF8
      <br />
      材料爆率更新补偿CDK：2012110000DA1TH064B
      <br />
      2020/12/14强化补偿CDK：2012110000DDMN55A1S
      <br />
      20级礼包CDK：20111100007736XTX494 20级限量CDK：2012110000DDWY23TYA
      <br />
      挂机bug补偿CDK：2012110000DF57W3R1AW
      <br />
      本游戏难度有点高,前期如果升错技能,可能会卡关一段时间,或者让大佬带你打副本,
      别看等级来决定你去挂哪个地图,等级基本没有强度加成,主要是限制装备和境界
    </p>
    ...
    <br />
    <p class="importantFontRed">
      组队的时候 必须满3个人才可进行战斗 组队只需要队长操作就行,
      队员不能在继续挂机普通图 队长战斗开始失败
      请看一下组队副本要求等级和自己队伍玩家的等级是否符合,组队副本每次奖励上限30次在金币下面可看
    </p>
    <br />
    <p class="importantFontRed">
