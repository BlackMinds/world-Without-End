<template>
    <div id="app2" :style="{ background: this.electronicEquipment == false ? bgColor : '' }">
        <vue-canvas-nest v-if="this.electronicEquipment == true" :config="{ color: '255,255,255', count: 100 }"></vue-canvas-nest>
        ...
        <div id="box">
            <div id="left">
                <Card>
                    ...
                    <Button slot="extra" @click.prevent="editName" size="small" type="info">
                        修改名字
                    </Button>
                    <div>
                        <div class="character">
                            <Upload type="drag" :before-upload="handleUpload" action="http://www.yunyingxiaowu.com:8088/foodie-api/gamepassport/uploadFace">
                                <div style="width: 100px; height: 100px; overflow: hidden">
                                    <p class="touxiang" :style="{ backgroundImage: 'url(' + user.face + ')' }"></p>
                                </div>
                            </Upload>
                ...
                <!-- 境界突破提示框 -->
                <Modal v-model="realmEject" title="境界突破提示" @on-ok="changeRealm" :styles="{ top: '240px' }">
                ...
                <!-- 修改名字弹出框 -->
                <Modal title="修改名字" v-model="nameEject" @on-ok="deteSetName" :styles="{ top: '100px' }">
              ...
              ">
                ...
                <Card>
                    <p slot="title">装备</p>
                    <div slot="extra">
                        <Button slot="extra" @click.prevent="allTake" size="small" type="info">
                            一键脱下
                        </Button>
                    </div>
                    ...
                    ">
                                    ...
                                    <Button @click.prevent="TakeOffsingleton(item)" size="small" type="info">
                                        脱下
                                    </Button>
                                </p>
                                <div slot="content">
                ...
                <!-- 切换地图弹出框 -->
                <Modal title="选择地图" v-model="mapEject" @on-ok="deteSetMap" :styles="{ top: '100px' }">
            ...
            <div id="center">
                ...
                <Card class="two">
                    ...
                    <!-- 批量使用弹出框 -->
                    <Modal width="620" title="结算离线" v-model="settlementjectEject" :styles="{ top: '100px' }">
                        <div>
                    ...
                    <!-- changeMap -->
                    <Button slot="extra" @click.prevent="reverseOffLine" size="small" type="success">
                        {{ this.user.online == 0 ? "开始离线" : "结算离线" }}
                    </Button>
                    <Button style="margin-left: 30px" slot="extra" @click.prevent="withdrawFromAction" size="small" type="warning" :loading="withdrawFromActionStatus">
                        退出战斗
                    </Button>
                    <Button style="margin-left: 30px" slot="extra" @click.prevent="
            ...
            " size="small" type="info">
                ...
                <!-- 强化提示框 -->
                <Modal v-model="strengthenEject" title="强化提示" @on-ok="changeStrengthen" :styles="{ top: '240px' }">
                ...
                <!-- 批量使用弹出框 -->
                <Modal width="620" title="批量使用" v-model="batchEject" @on-ok="bulkPurchase()" :styles="{ top: '100px' }">
                    <div>
                ...
                <Card style="margin-top: 30px">
                    ...
                    ">
                                    ...
                                    <span class="jjt_smail" v-if="item.itemType == 3 || item.itemType == 4">
                                        {{ item.itemNum }}
                                    </span>
                                    <Button @click.prevent="equipment(item)" size="small" v-if="item.itemType != 3 && item.itemType != 4" type="info">
                                        装备
                                    </Button>
                                    ...
                                    <Button @click.prevent="sellSingle(item)" size="small" v-if="item.itemType != 3 && item.itemType != 4" type="info">
                                        出售
                                    </Button>
                                </p>
                        ...
                        ">
                                        ...
                                        <template v-if="Equipment.affixVoList">
                                            <p v-for="cz in Equipment.affixVoList" :key="cz.affixDescribe" :style="{
                          color:
                            cz.affixLevel == 'T1'
                              ? 'rgb(234 255 0)'
                              : 'rgb(73, 193, 248)',
                ...
                <Card>
                    ...
                    ">
                                    ...
                                    <Button @click.prevent="useItems(item)" size="small" v-if="item.itemType == 3 && item.itemType != 4" type="info">
                                        使用
                                    </Button>
                                    <Button @click.prevent="hatch(item)" size="small" v-if="item.itemType == 9" type="info">
                                        孵化
                                    </Button>
